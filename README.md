...
When running the script for longer time intervals, the data shows that the two Uniswap v3 pools, the USDC and WETH (at 0.05% and 0.3% fee tiers) transactions maintain extremely close prices, typically within 0.01% - 0.15% of each other. This narrow range shows the efficiency of Uniswap v3 and the way liquidity and arbitrage work on the Ethereum chain.
